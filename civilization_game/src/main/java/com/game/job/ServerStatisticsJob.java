...
public class ServerStatisticsJob {
    ...
    @Autowired
    WorldTargetTaskService worldTargetTaskService;
    ...
    private void sendLoggerConsumer() {
        ...
        for (Map.Entry<Integer, List<Player>> channelList : result.entrySet()) {
            ...
            eventManager.online_user_amount(online, serverManager.getServerId(), serverManager.getServerId());
    ...
    private void resetBigMonster() {
        worldManager.getAllMap().forEach(e -> {
