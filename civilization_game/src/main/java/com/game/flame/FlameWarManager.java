...
public class FlameWarManager {
    ...
    public void initMap() {
        ...
        flameBuildMap.values().forEach(x -> {
            ...
            flameMap.addPos(pos, flameWarCity);
//			flameMap.addNode(pos, flameWarCity);
            if (x.getType() == 5) {
        ...
        while (iterator2.hasNext()) {
            ...
            for (FlamePlayer value : next.values()) {
                ...
                if (playerCity != null) {
                    ...
                    PlayerCity playerCity1 = worldManager.changePlayerPos(player, randPos);
                    if (playerCity1 != null) {
                ...
                achievementService.addAndUpdate(player, AchiType.AT_20, 1);
    ...
    public void flushMine(StaticFlameFlushMine mine) {
        ...
        for (int i = 0; i < flushNum; i++) {
            ...
            LogHelper.GAME_LOGGER.info("定时刷资源矿 pos:{}", pos);

            boolean flag = flameMap.addPos(pos, node);
            if (!flag) {
                continue;
            }
            ...
            if (march != null) {
                ...
                if (march.getMarchType() == MarchType.FLAME_WAR) {
                    ...
                    if (resource != null) {
                        ...
                        if (collectArmy != null && collectArmy.getFirst() != null) {
                            if (collectArmy.getFirst().getMarch() == march) {
